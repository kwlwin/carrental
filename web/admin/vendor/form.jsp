                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <%
                                            ...
                                            ResultSet rs = vendor.GetBy("id", request.getParameter("id"));
                                            int c = 0;
                                            if (rs.next()) {

                                        %>
                                        <form action="add_vendors" method="post" role="form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="vendor_name" value="<%= rs.getString("name")%>">
                                            </div>
